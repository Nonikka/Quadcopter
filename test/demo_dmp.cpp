...
float Acceleration[3],AngleSpeed[3],Angle[3],Roll,Pitch,Yaw,DutyCycle[4],Accelerator,Pid_Pitch,Pid_Roll=0,Default_Acc = 0.22;
float error=0;
...
void* gyro_acc(void*)
{
    ...
    float kp = 0.0132,ki = 0.0,kd = 0.0045;
